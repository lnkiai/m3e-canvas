...
export const UI = {
  ...
  labelMode: { ja: "ラベルの表示", en: "Labels", zh: "标签显示" },
  labelsAlways: { ja: "常に表示", en: "Always", zh: "始终显示" },
  labelsSelected: { ja: "選択中のみ", en: "Selected only", zh: "仅选中项" },
  labelsNever: { ja: "非表示", en: "Hidden", zh: "隐藏" },
  badgeDot: { ja: "ドットバッジ", en: "Dot badge", zh: "圆点徽标" },
  badgeCount: { ja: "件数", en: "Count", zh: "计数" },
