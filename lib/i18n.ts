...
export const UI = {
  ...
  askAiEdit: { ja: "このデザインを編集", en: "Edit this design", zh: "编辑此设计" },
  askAiEditTitle: { ja: "この指示をキャンバス上のデザインにあてる", en: "Applies the text to the design on the canvas", zh: "把这段文字应用到画布上的设计" },
...
export const KO: Record<UIKey, string> = {
  ...
  askAiEdit: "이 디자인 편집", askAiEditTitle: "캔버스의 디자인에 이 지시를 적용",
